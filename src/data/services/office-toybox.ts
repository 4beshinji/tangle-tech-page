...
export const officeToybox: Service = {
  ...
  highlights: [
    {
      title: "CoreHub内で完結するデータ処理",
      body: "センサーと映像を各CoreHub内で処理し、管理基盤には構造化イベントと集計値を送信。個人情報の保持範囲を拠点内に閉じる。",
    },
    {
  ...
  media: {
    hero: {
      ...
      context:
        "Sushitech 2026向けカスタムでは、指定PCへのOS導入、約250GBのローカル推論環境、イベント案内、TTS機能を現地条件に合わせて構築。『顔を向けた相手に話す』『通行人数に応じて発話する』など、空間情報を用いた対人インタラクションを実装。",
    },
    gallery: [
      {
